...
机缘巧合，朋友推荐。<br>
在我看来，pixman是一个方便各位同好订阅各种已经被大佬调整好了的（免去ipv6以及梯子烦恼）源的一个docker，它的订阅方式非常简单方便。
...
<br>当然，如果你觉得你看不明白，那就直接看我以下食用方法。<br>
（**仅仅适用于群晖系统,如果你动手能力强，各种NAS系统其实也差不多**）
...
原代码如下:
  ...
  所以我在文件中特地换了两个端口，而这两个新的端口很难和其他进程有相冲突的情况。<br><br> 
...
### 5.完成Docker的搭建，开始订阅，享受观影的乐趣
参考以下订阅地址，将订阅地址根据你的服务器来修改相对应的参数，即可完成订阅！

### 到这里，保证Docker成功运行，就可以不用管Docker和服务器，只需要关注你的APTV就行了。
...
#### 另外，推荐 **Github YanG-1989** 大佬的[m3u仓库](https://github.com/YanG-1989/m3u)及他的[订阅集合网站](https://yang-1989.eu.org/)。
...
---
## 七、鸣谢（以下排名以拼音排序，排名不分先后）    
* **Coding 大佬** Pixman及pixman.io论坛作者 
* **靓仔东** 项目推荐者 
* **了了** 提供DSM相关网络支持
* **YanG-1989** Github相关领域创作者